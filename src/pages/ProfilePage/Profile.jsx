...
if (!userLogin) {
        ...
        <div className={styles.profile}>
          <div className={styles['user-info']}>
            <div className={styles.userInfo} >
              ...
              <input className={styles.userValue} type="text" name="" id="" value={userLogin.result.username} />
            </div>
            <div className={styles.userInfo}>
              <p className={styles.userLabel} >Email: </p>
             <input className={styles.userValue} type="text" name="" id="" value={userLogin.result.email} />
            </div>
          </div>
  ...
  {friends.length === 0 ? (
    <li style={{ paddingLeft: '20%' }} className={styles.friendsItem }>Add Friends by seacrhing Username ↑</li>
  ) : (
          ...
          Delete
            ...
            <div className={styles.ratings} >
              ...
              {handles.map(({ handle, currentRating }) => (
                ...
                <li className={styles.friendsItem} key={handle}>
